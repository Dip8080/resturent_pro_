        ...
        return Container(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(child: ProfileTextFieldWidget(
                    isShowBorder: true,
                    controller: widget.inputModel.locationTextController..text = locationProvider.address ?? '',
            ...
            Expanded(child: Column(children: [
              /// Map section
              SizedBox(height: 300, width: MediaQuery.of(context).size.width, child: ClipRRect(
