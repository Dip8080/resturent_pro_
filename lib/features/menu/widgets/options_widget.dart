        ...
        child: Column(children: [
          ...
          SizedBox(height: MediaQuery.sizeOf(context).height * 0.13,
            child: CustomScrollView(
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child: CardButtonWidget(
                  title: getTranslated('favourite', context)!,
                  image: Images.favoriteSvg,
                  onTap: () => RouterHelper.getDashboardRoute('favourite'),
                )),

               if(splashProvider.configModel?.walletStatus ?? false) SliverToBoxAdapter(child: CardButtonWidget(
                  title: getTranslated('wallet', context)!,
                  image: Images.walletSvg,
                  onTap: () => RouterHelper.getWalletRoute(),
                )),

                if(splashProvider.configModel?.loyaltyPointStatus ?? false) SliverToBoxAdapter(child: CardButtonWidget(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Padding(
              ...
              child: Text(getTranslated('general', context)!, style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
            ),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
              child: Text(getTranslated('menu_more', context)!, style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
            ),
