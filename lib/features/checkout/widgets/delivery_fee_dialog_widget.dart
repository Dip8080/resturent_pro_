...
class DeliveryFeeDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double deliveryCharge = CheckOutHelper.getDeliveryCharge(
      distance: distance,
      shippingPerKm: splashProvider.configModel?.deliveryManagement?.shippingPerKm ?? 0,
      minShippingCharge: splashProvider.configModel?.deliveryManagement?.minShippingCharge ?? 0,
