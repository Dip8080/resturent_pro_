        ...
        locationProvider.addressList == null ? _AddressShimmerWidget(
          ...
          Expanded(child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              bool isAvailable = CheckOutHelper.isAddressInCoverage(currentBranch, locationProvider.addressList![index]);
                      ...
                      Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall), child: Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            Text(locationProvider.addressList![index].addressType!, style: rubikMedium.copyWith(
          ...
          if(locationProvider.addressList?.isNotEmpty ?? false) TextButton.icon(
            ...
            child: Column( children: [
              ...
              Text(getTranslated("select_address", context)!, style: rubikMedium.copyWith(
