...
class CreateNewPasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<AuthProvider>(builder: (context, auth, child) => Center(child: SingleChildScrollView(
                      ...
                      onTap: () {
                        if (_passwordController.text.isEmpty) {
                          ...
                          auth.resetPassword(emailOrPhone, resetToken, _passwordController.text, _confirmPasswordController.text).then((value) {
                            if(value.isSuccess) {
                              auth.login(emailOrPhone, _passwordController.text).then((value) async {
