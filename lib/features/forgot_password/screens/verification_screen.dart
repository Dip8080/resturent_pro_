...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen({super.key, required this.emailAddress, this.fromSignUp = false, this.session});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context)
          ...
          : CustomAppBarWidget(context: context, title: getTranslated(isPhone ? 'verify_phone' : 'verify_email', context))) as PreferredSizeWidget?,
