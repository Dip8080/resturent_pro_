            ...
            builder: (context, cart, child) {
              ...
              for (var cartModel in cart.cartList) {
                ...
                for(int index=0; index<addOnList.length; index++) {
                  ...
                  addOnsTax = addOnsTax + ((addOnList[index].tax ?? 0) * (cartModel.addOnIds?[index].quantity ?? 1));
                }
              ...
              bool kmWiseCharge = splashProvider.configModel?.deliveryManagement?.status ?? false;
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Text(getTranslated('apply_promo', context)!, style: rubikMedium),
                                        const Spacer(),
