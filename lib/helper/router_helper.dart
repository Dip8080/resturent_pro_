...
import 'package:flutter_restaurant/features/maintainance/screens/maintainance_screen.dart';
...
class RouterHelper {
  ...
  static  Widget _routeHandler(BuildContext context, Widget route,  {bool isBranchCheck = false, required String? path}) {
   return Provider.of<SplashProvider>(context, listen: false).configModel == null
       ? SplashScreen(routeTo: path) : Provider.of<SplashProvider>(context, listen: false).configModel!.maintenanceMode!
